...
### SSL/TLS Version
Select a SSL/TLS version to create load balancer. The created load balancer communicates with clients using only the selected version and a version higher than the selected version, as shown below.
