...
| host_header | Query | String | - | Field value of the host header to use for status check<br>When the status check type is set with `TCP`, value set in this field will be ignored.|
...
| healthmonitors.host_header | Body | String | Field value of the host header to use for status check<br>When the status check type is set with `TCP`, value set in this field will be ignored.|
