...
* タイプ：一般、専用、物理Basic、物理Premiumのいずれかを選択できます。L4ルーティングモードのロードバランサーは、一般、専用、物理Basic、または物理Premiumのいずれかを選択できます。L7ルーティングモードのロードバランサーは、一般または専用を選択できます。
...
* 基本メンバーグループ：トラフィックの受信時に基本的に分配されるメンバーグループを指定します。
...
* 状態確認ポート：状態確認を試みるメンバーのポートを設定します。
...
#### メンバーの追加
メンバーグループを選択すると、画面下部に**基本情報**、**メンバー**、**状態確認**タブが表示されます。**メンバー**タブを選択し、任意のインスタンスまたはIPアドレスをメンバーとして登録できます。インスタンスの追加は、ロードバランサーが接続されたVPCおよびそのVPCにピアリングされたVPCに属するインスタンスのみ可能です。
