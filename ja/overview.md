...
ロードバランサーは[VPC](/Network/VPC/ko/overview/#_2)の[サブネット](/Network/VPC/ko/overview/#_2)で作成されます。ロードバランサーは作成時に指定されたサブネットからIPを割り当てられ、自分のIPで使用します。また指定されたサブネットと同じVPCに属すインスタンスをメンバーが登録し、流入したトラフィックを分配します。他のVPCに属すインスタンスは追加できません。
