...
IP 접근제어 기능에 대한 자세한 사항은 [IP 접근제어](/Network/Load%20Balancer/ko/overview/#load-balancer-ip-access-control) 문서를 참고합니다.
...
SSL 정책은 리스너에서 사용할 최소 TLS 버전과 암호화 스위트의 조합을 정의한 사용자 정의 보안 정책입니다. SSL 정책의 개념과 선택 가능한 암호화 스위트 목록은 [사용자 정의 SSL 정책](/Network/Load%20Balancer/ko/overview/#custom-ssl-policy) 문서를 참고합니다.
