...
>
> 로드밸런서의 리스너 프로토콜을 TERMINATED_HTTPS 로 지정한 경우 SSL 인증서를 등록하는 버튼이 활성화됩니다.
>
> 등록해야 할 파일은 "인증서"와 서버인증서에 내장된 공개키에 대응하는 "개인키"입니다.
>
...
>
> 인증서 파일을 하나로 만들때에는 파일의 최상단에 서버 인증서를 기술하고 아래에 체인인증서들을 나열해야합니다. 체인인증서는 순서에 상관없이 나열해도 됩니다.
>
...
>
>
> "개인키"는 서버 인증서에 포함된 공개키에 대응하는 키 파일입니다.
>
> PKCS#1 또는 PKCS#8 PEM 형식을 갖는 개인키를 등록할 수 있습니다.
>
>
>
