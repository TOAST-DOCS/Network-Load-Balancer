...
>
> 등록해야 할 파일은 "인증서"와 "개인키" 입니다. "개인키"는 서버 인증서에 내장된 공개키와 쌍을 이루는 개인키를 의미합니다.
>
...
>
> 인증서 파일을 하나로 만들때에는 파일의 최상단에 서버 인증서를 기술하고 그 하단에 체인 인증서들을 기술해야 합니다. 체인 인증서는 순서에 상관없이 기술 가능합니다.
>
