...
* 로드 밸런서 사용 요금: **ACTIVE** 상태인 로드 밸런서가 사용된 기간만큼 요금이 청구됩니다. 이용 요금에 대한 자세한 사항은 [로드 밸런서 타입별 요금](https://ngsc-nhncloud.com/kr/service/network/load-balancer)을 참고하시기 바랍니다.
