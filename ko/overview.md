...
* 접근제어 그룹
     ...
     * 그룹은 이름, 메모, Action 등의 속성을 가집니다.
     * 접근제어 그룹의 속성 중 Action은 '허용(Allow)'와 '거부(Deny)'로 구분됩니다.
...
* 접근제어 그룹을 로드밸런서에 적용
     ...
     * 한 로드밸런서에 여러 접근제어 그룹을 적용할 수 있습니다. 단, Action이 동일한 그룹만 적용 가능합니다.
...
> |--|--|--|--|
> | 제어 위치| 인스턴스 | 로드밸런서 |
> | 설정 대상 설정 | IP, Port, Protocol 등 설정 | IP 만 설정 |
> | 제어 트래픽 | In / Out 트래픽 방향 설정 가능 | In 트래픽 대상 |
> | 제어 방법| Allow Only | Allow 또는 Deny 설정 가능 |
