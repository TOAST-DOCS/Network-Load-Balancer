...
| key-manager | 한국(판교) 리전 | https://api-key-manager-infrastructure.ninc.go.kr |
  ...
  "listeners": [
    {
      ...
      "tls_version": "TLSv1.0",
      "sni_container_ids": [],
      "default_tls_container_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/containers/c8f4503c-1da5-4ec7-9456-51183bd4ad4e",
      "sni_container_refs": [],
      "protocol_port": 443,
...
```json
{
  "secrets": [
    {
      ...
      "mode": null,
      "name": "certificate",
      "secret_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/secrets/adffcd66-ff63-4c66-8139-2f254e63aef5",
    ...
    },
    {
      ...
      "mode": null,
      "name": "private_key",
      "secret_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/secrets/36f88d4c-16f0-4db2-80bc-4dda0125589b",
      "secret_type": "private",
      "status": "ACTIVE",
      "updated": "2019-12-17T08:50:39"
    }
  ...
  "total": 10,
  "next": "https://api-key-manager-infrastructure.ninc.go.kr/v1/secrets?limit=1&offset=2",
  "previous": "https://api-key-manager-infrastructure.ninc.go.kr/v1/secrets?limit=1&offset=0"
}
...
```json
{
    "secret_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/secrets/9b2dcb7b-51fe-4408-a2bb-23da731758a6"
}
```
</p>
</details>
...
{
  "total": 10,
  "previous": "https://api-key-manager-infrastructure.ninc.go.kr/v1/containers?limit=1&offset=0",
  "next": "https://api-key-manager-infrastructure.ninc.go.kr/v1/containers?limit=1&offset=2",
  "containers": [
    {
      "status": "ACTIVE",
      "updated": "2019-12-17T08:50:39",
      ...
      "consumers": [],
      "created": "2019-12-17T08:50:39",
      "container_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/containers/2d1dcf4d-2e92-475e-bde7-e469880be924",
      "creator_id": "1da4ce9f59ed4f6487c9be39fa792be4",
      "secret_refs": [
        {
          "secret_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/secrets/adffcd66-ff63-4c66-8139-2f254e63aef5",
...
```json
{
    ...
    "secret_refs": [
        {
            "name": "private_key",
            "secret_ref": "https://api-key-manager-infrastructure.ninc.go.kr/cf11edcf-f475-47f3-92c3-29de8bcdd639"
        }
    ]
}
```
...
```json
{
    "container_ref": "https://api-key-manager-infrastructure.ninc.go.kr/v1/containers/ea2e90fc-1ba2-412b-b7a0-61da4402bf58"
}
```
</p>
</details>
