...
负载平衡处理的网络流量相关的各种统计指标可以通过图表确认。TOAST负载均衡统计功能的特点如下。
...
该功能不同于[安全组](/Network/VPC/ko/console-guide/#_6)的功能，区别如下。
...
> [参考]
> 若使用[TOAST Security Monitoring](/Security/Security%20Monitoring/ko/Overview/)服务，可以找出具有威胁性的远程IP。
>
